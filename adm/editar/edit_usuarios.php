        ...
        <div class="well conteudo">
            ...
            <input type="hidden" name="id" value="<?php echo $row_usuario['id']; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="email" class="form-control" placeholder="E-mail" value="<?php 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="usuario" class="form-control" placeholder="Usuário" value="<?php 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="senha" class="form-control" placeholder="Senha" value="<?php 
