...
<div class="well conteudo">
    <div class="pull-right">
        <a href="<?php echo pg . '/listar/list_usuarios' ?>"><button type="button"
                class="btn btn-xs btn-roxo">Listar</button></a>
    </div>
    ...
    <form action="<?php echo pg; ?>/processa/proc_cad_usuarios" method="POST" class="form-horizontal"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="usuario" class="form-control" placeholder="Usuário para logar nio sistema"
                    value="<?php if (isset($_SESSION['dados']['usuario'])) {
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="password" name="senha" class="form-control"
                    placeholder="A senha alfanúmerica com mínimo 6 caracteres" value="<?php if (isset($_SESSION['dados']['senha'])) {
        ...
        if ($_SESSION['niveis_acesso_id'] == 1) {
            ...
            $result_niv_acesso = "SELECT * FROM niveis_acessos WHERE ordem > (SELECT ordem FROM niveis_acessos WHERE id = '" . $_SESSION['niveis_acesso_id'] . "')";
        }
